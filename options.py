...
def parse_args(script):
    ...
    parser.add_argument('-resume_epoch', default=None, type=str, help='')
    ...
    parser.add_argument('-pow_on_final_map_train', type=float, default=1.0)
    parser.add_argument('-pow_on_final_map_test', type=float, default=1.0)
    parser.add_argument('-aux_param', type=float, default=0.0)
...
def get_resume_file(checkpoint_dir, resume_epoch=-1):
    ...
    '''
    resume_file = os.path.join(checkpoint_dir, '%s.tar'%(resume_epoch))
    return resume_file
